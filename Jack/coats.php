	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryDogCoats = $db->query("SELECT * FROM product WHERE Category = 'DogCoats'"); //query to retrieving the products relating to the category
				
				while($row = $qryDogCoats->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Coats</h2></center>";
				echo "<br>";

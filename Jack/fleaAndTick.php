	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryFleaAndTick = $db->query("SELECT * FROM product WHERE Category = 'FleaAndTick'"); //query to retrieving the products relating to the category
				
				while($row = $qryFleaAndTick->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Flea And Tick</h2></center>";
				echo "<br>";

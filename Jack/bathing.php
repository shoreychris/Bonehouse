	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryBathing = $db->query("SELECT * FROM product WHERE Category = 'Bathing'"); //query to retrieving the products relating to the category
				
				while($row = $qryBathing->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Bathing</h2></center>";
				echo "<br>";

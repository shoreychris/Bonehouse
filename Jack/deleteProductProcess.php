...
<html>
	...
	<body>
		<div class=content>
			...
			$display.='<td style="text-align: center"><a href=deleteButton.php?theID='.$row["ProductID"].'><img src="Images/deleteButton.jpg" width=200 height=200 align=auto></a></td>';
			$display.='</tr>';	

			$display.="</table></center>";
			echo "<br>";
			echo "<center><h2 style='color:#21aaa7'>Delete Product</h2></center>";
			echo "<br>";
			echo $display;		

	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryBeds = $db->query("SELECT * FROM product WHERE Category = 'DogBeds'"); //query to retrieving the products relating to the category
				
				while($row = $qryBeds->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Beds</h2></center>";
				echo "<br>";

	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qrySoftToys = $db->query("SELECT * FROM product WHERE Category = 'SoftToys'"); //query to retrieving the products relating to the category
				
				while($row = $qrySoftToys->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Soft Toys</h2></center>";
				echo "<br>";

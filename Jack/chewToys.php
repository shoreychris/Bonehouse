	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryChewToys = $db->query("SELECT * FROM product WHERE Category = 'ChewToys'"); //query to retrieving the products relating to the category
				
				while($row = $qryChewToys->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Chew Toys</h2></center>";
				echo "<br>";

	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryGrooming = $db->query("SELECT * FROM product WHERE Category = 'Grooming'"); //query to retrieving the products relating to the category
				
				while($row = $qryGrooming->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Grooming</h2></center>";
				echo "<br>";

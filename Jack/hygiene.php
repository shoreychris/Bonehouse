	...
	<body>
		<div class=content>
			...
			<?php
				...
				$qryHygiene = $db->query("SELECT * FROM product WHERE Category = 'Hygiene'"); //query to retrieving the products relating to the category
				
				while($row = $qryHygiene->fetch())//while query is exceuted, table rows are looped through until each product is fetched
				{
					$display.= '<tr>';
				...
				echo "<br>";
				echo "<center><h2 style='color:#21aaa7'>Hygiene</h2></center>";
				echo "<br>";

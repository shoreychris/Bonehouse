...
<html>
	...
	<body>
		<div class=content>
			...
			$display.='<td style="text-align: center"><a href=basket.php?theID='.$row["ProductID"].'><img src="Images/addToCart.JPG" width=180 height=50 align=auto></a></td>';
			$display.='</tr>';	

			$display.="</table></center>";
			echo "<center><h2 style='color:#21aaa7'>Products</h2></center>";
			echo $display;				
			?>
			<br>

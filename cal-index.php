...
<html>
 <head>
  ...
  <button onclick="Function()">Help!</button>
<script>
function Function() 
{
    alert("For multiple days, click and hold on a day and drag to last day of leave. \nFor single days click once on required day \nTo delete click on event and select delete.");
}
</script
  <br>
